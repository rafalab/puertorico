...
#' @param municipio logical argument. Defaults to FALSE. If TRUE, it returns populations estimates by municipio for preselected age groups. For ACS and Decennial products, municipio is always TRUE.
...
#' get_census_estimates(2011:2015, product = "acs", municipio = TRUE, census_key = your_census_key)
#' }
#' @import data.table httr jsonlite stringr
#' @importFrom purrr map_df
#' @importFrom dplyr recode
#' @export
get_census_estimates <- function(years, product, municipio, census_key) {
